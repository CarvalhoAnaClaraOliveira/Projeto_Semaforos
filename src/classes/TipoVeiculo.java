...
class Ambulancia extends Veiculo {
    ...
    public Ambulancia(int id, String direcao, int velocidade, Prioridade prioridade, String tipoAtendimento, int capacidadePacientes) {
        // Passa os parâmetros obrigatórios e gera a placa automaticamente usando o Gerador
